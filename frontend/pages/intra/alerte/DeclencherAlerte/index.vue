<template>
  <div>
      <div class="titre">
        ...
        <h3 style="padding-top:20px;"> Déclencher une alerte </h3>
      </div>
      <div class="mesAlertes">
        <button onclick="declencherCanicule()">Déclencher une Alerte Canicule</button>
        <button onclick="declencherGrandFroid()">Déclencher une Alerte Grand Froid</button>
        <button onclick="declencherEpidemie()">Déclencher une Alerte Epidémie</button>
        <p id="demo"></p>
